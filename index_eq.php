					...
					<div class="moving-size">
						...
						<div class="col-i">
							<div id="select-arrow"></div>
								<select name="number_of_rooms" id="move_size">
								<?php
								$options = array(
									'moving boxes only' => 'Moving Boxes Only',
									'studio'	=>	'Studio',
									'one bedrooms apartment'	=>	'1 Bedroom Apt',
									'one bedrooms house'		=>	'1 Bedroom House',
									'two bedrooms apartment'	=>	'2 Bedroom Apt',
									'two bedrooms house'		=>	'2 Bedroom House',
									'three bedrooms apartment'	=>	'3 Bedroom Apt',
									'three bedrooms house'		=>	'3 Bedroom House',
									'four bedrooms apartment'	=>	'4 Bedroom Apt',
									'four bedrooms house'		=>	'4 Bedroom House',
									'five bedrooms apartment'	=>	'5 Bedroom Apt',
									'five bedrooms house'		=>	'5 Bedroom House',
									'six bedrooms apartment'	=>	'6 Bedroom Apt',
									'six bedrooms house'		=>	'6 Bedroom House',
									'six bedrooms and more apartment'	=>	'6 or more Bedroom Apt',
									'six bedrooms and more house'		=>	'6 or more Bedroom House'
								);
								foreach($options as $key => $value){
									if($key == $this->number_of_rooms){
										echo '				<option class="select-active" value="'.$key.'" selected="selected">'.$value.'</option>'."\n";
									}else{
										echo '				<option class="select-active" value="'.$key.'">'.$value.'</option>'."\n";
									}
								}
								?>
							</select>						</div>
				...
				<div class="form-area">
					<form id="f-step3">
						...
						<div>
							...
							<button class="submit-form" onclick=""  id="get-my-quotes">GET MY QUOTES</button>
						</div>
					</form>
				</div>
				<div class="right-col">
